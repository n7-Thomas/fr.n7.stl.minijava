...
public class SymbolTable implements HierarchicalScope<Declaration> {
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.scope.Scope#get(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.scope.Scope#contains(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.scope.Scope#accepts(fr.n7.stl.minijava.ast.scope.Declaration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.scope.Scope#register(fr.n7.stl.minijava.ast.scope.Declaration)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.scope.HierarchicalScope#knows(java.lang.String)
	 */
	@Override
	public boolean knows(String _name) {
		//System.out.println("lf: '" + _name + "'");
