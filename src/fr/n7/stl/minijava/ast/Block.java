...
public class Block {
	...
	public void allocateMemory(Register _register, int _offset) {
		int dep = _offset;
		//System.out.println(this.instructions + " = " + _register + " : " + _offset);
		for (Instruction _instruction : this.instructions) {
			dep += _instruction.allocateMemory(_register, dep);
			
		}
		this.tailleMemoire = dep;
	}
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		// Get code de chaque instruction
