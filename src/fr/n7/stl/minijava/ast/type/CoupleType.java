...
public class CoupleType implements Type {
	...
	/* (non-Javadoc)
	 * @see fr.n7.minijava.ast.Type#equalsTo(fr.n7.minijava.ast.Type)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.minijava.ast.Type#compatibleWith(fr.n7.minijava.ast.Type)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.minijava.ast.Type#merge(fr.n7.minijava.ast.Type)
	 */
	@Override
