...
import fr.n7.stl.minijava.ast.type.declaration.LabelDeclaration;
...
public class EnumerationType implements Type, Declaration {
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.type.Type#equalsTo(fr.n7.stl.minijava.ast.type.Type)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.type.Type#compatibleWith(fr.n7.stl.minijava.ast.type.Type)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.type.Type#merge(fr.n7.stl.minijava.ast.type.Type)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.type.Type#length()
	 */
	@Override
	public int length() {
