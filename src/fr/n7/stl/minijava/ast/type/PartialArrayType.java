...
public class PartialArrayType extends ArrayType implements PartialType {
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.type.PartialType#complete(fr.n7.stl.minijava.ast.type.Type)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see fr.n7.stl.minijava.ast.type.PartialType#enrich(fr.n7.stl.minijava.ast.type.PartialType)
	 */
	@Override
